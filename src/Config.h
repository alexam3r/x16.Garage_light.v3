...
// Авто-возврат реакции на PIR: если её отключили командой motion/set OFF,
// через это время реакция сама включится (сброс к дефолту, если ушёл из гаража).
#define MOTION_AUTO_ENABLE_MS   21600000UL   // 6 часов
